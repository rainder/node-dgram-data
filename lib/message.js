...
module.exports = class Message {
   ...
   * @returns {Message}
   */
  static createFromBuffer(buffer, packet_size = Packet.SIZE) {
    const message = new Message(bson.ObjectID().toString(), packet_size);
   ...
   */
  addPacket(packet) {
    if (this.chunks[packet.seq] !== undefined) {
      return;
    }
